...
int
machine_at_ergoe452_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/ergoe452/B58_G.LDB",
                           0x000e0000, 131072, 0);
    ...
    pci_register_slot(0x07, PCI_CARD_NORMAL,      0, 0, 0, 0);
    ...
    if (gfxcard[0] == VID_INTERNAL)
        device_add(&mach64vt2_onboard_device);
